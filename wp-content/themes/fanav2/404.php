...
<div class="container">
  <div class="row">
    <div class="col-lg-6 mx-auto my-5">
      <div class="img-404">
        <img src="<?php echo LATOYA_THEME_URI . '/assets/images/img-404.jpg' ?>" alt="Img 404" class="lazyloaded">
      </div>
      <section class="error-404 text-center mt-4">
        ...
        <div class="content-404">
          ...
          <a href="<?php echo get_home_url(); ?>" class="button back"><?php esc_html_e('home page', LATOYA_THEME_DOMAIN); ?></a>
        </div>
      </section>
    </div>
  </div>
