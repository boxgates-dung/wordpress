...
define('THEME_OPTIONS_DOMAIN', 'Fanalya');
...
// Modules
require_once THEME_OPTIONS_DIR . 'modules/header-footer-builder.php';
require_once THEME_OPTIONS_DIR . 'modules/mega-menu.php';
