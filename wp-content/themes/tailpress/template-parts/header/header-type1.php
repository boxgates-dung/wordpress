  ...
  <div class="container m-auto h-20 flex justify-between items-center">
    ...
    <div class="header-icon">
      <div class="header-top-buttons flex justify-between items-center gap-3">
        <div class="top-action-btn relative">
        ...
        <div class="top-action-btn relative" data-name="cart">
        ...
        <div class="top-action-btn relative" data-name="wishlist">
        ...
        <div class="top-action-btn relative" data-name="compare">
        ...
        <div class="top-action-btn relative" data-account-action="account">
