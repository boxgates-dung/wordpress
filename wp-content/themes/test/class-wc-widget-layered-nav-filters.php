 ...
 */
class WC_Widget_Layered_Nav_Filterss extends WC_Widget
{
...
class Widget_Layered_Nav_Filters extends WC_Widget
{
  public static function getInstance()
  {
    static $instance = null;
  ...
  public function __construct()
  {
    add_action('active_filter', [$this, 'active_filter']);
  }
...
Widget_Layered_Nav_Filters::getInstance();
