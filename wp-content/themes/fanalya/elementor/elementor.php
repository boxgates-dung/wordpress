...
//		add_action('wp_ajax_jpro_filter', [$this, 'ajaxProjects']);
	...
	public function init_widgets()
	{
		...
		// Register widget
		// Plugin::instance()->widgets_manager->register(new ProductTab());
	...
	function init_page_settings_controls(Elementor\Core\DocumentTypes\PageBase $page): void
	{
		$page->add_control(
			'show_key_background',
			[
	...
	public function elementor_group($font_groups): array
	{
